#
#  Be sure to run `pod spec lint LYStickiBall.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "instal-b"
  # s.authors            = { "instal-b" => "645256685@qq.com" }
  # s.social_media_url   = "http://twitter.com/instal-b"
